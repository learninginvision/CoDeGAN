...
if __name__ == "__main__":
    ...
    model_dir = {"checkpoint":"./checkpoint", "samples_G":"./samples_G", "samples_GEMA":"./samples_GEMA"}
    ...
    solver.Classifier.load_state_dict( torch.load('./chairs_data/Classifier.pth', map_location=solver.device))
    solver.Classifier.eval()

    if pretrain is True:
        solver.EC.load_state_dict(torch.load('./chairs_data/pre_EC.pth', map_location=solver.device))
